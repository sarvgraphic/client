var AppInbox = function () {
    ...
    var loadInbox = function (el, name) {
        console.log(el,name);
        var url = 'views/message/inbox/inbox.html';
    ...
    var loadMessage = function (el, name, resetMenu) {
        var url = 'views/message/list/app_inbox_view.html';
    ...
    var initWysihtml5 = function () {
        $('.inbox-wysihtml5').wysihtml5({
            "stylesheets": ["../../../resource/theme/global/lib/bootstrap-wysihtml5/wysiwyg-color.css"]
        });
    }
    ...
    var loadCompose = function (el) {
        var url = 'views/message/list/app_inbox_compose.html';
